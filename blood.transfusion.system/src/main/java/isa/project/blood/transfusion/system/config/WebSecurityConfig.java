package isa.project.blood.transfusion.system.config;
...
import isa.project.blood.transfusion.system.security.RestAuthenticationEntryPoint;
import isa.project.blood.transfusion.system.security.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurity web) throws Exception {
		...
		antMatchers(HttpMethod.GET, "/api/users/activate/{username}", "/api/centers/all");
